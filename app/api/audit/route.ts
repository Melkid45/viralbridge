...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    try {
      auditPayload = JSON.parse(rawResponse);
    } catch {
      auditPayload = { raw_response: rawResponse.slice(0, 4_000) };
    }
